...
{
    public partial class Salon2_k : Form
    {
        public Salon2_k()
        {
            InitializeComponent();
        ...
        private void Salon2_k_Load(object sender, EventArgs e)
        {
            label15.Text = Salon2_k.kllnc_adı;
            label4.Text = Salon2_k.filmadı2;
            label5.Text = Salon2_k.seansgunu2;
            label6.Text = Salon2_k.seanssaati2;
            if (label15.Text == "Misafir")
            {
                rb_2.Visible = false;
