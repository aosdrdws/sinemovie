...
namespace Sinema_Otomasyonu
{
    public partial class Salon2 : Form
    {
        ...
        public static string filmadı2 { get; set; }
        public static string seansgunu2 { get; set; }
        public static string seanssaati2 { get; set; }
        private void Salon2_Load(object sender, EventArgs e)
        {
            label4.Text = Salon2.filmadı2;
            label5.Text = Salon2.seansgunu2;
            label6.Text = Salon2.seanssaati2;
            baglanti.Open();
            ...
            komut.Parameters.AddWithValue("@salon_no", "Salon 2");
        ...
        // Koltuk Seçme
        private void btn_clck2(object sender, EventArgs e)
        {
                ...
                else
                {
                    ...
                    foreach (string i in koltuk_list)
                    {
                        if (i != "")
                        {
                            ...
                            komut3.CommandText = "INSERT INTO Salon(Koltuk_no,Seans_gunu,Seans_saati,Salon_no,Ucret)Values (@koltuk,@seans_gunu,@seans_saati,@salon_no,@ucret)";
